    ...
    <div className="space-y-10 animate-slide-up p-4">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
        <div>
          ...
          <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight">Student Manager</h2>
          <p className="text-slate-500 font-medium mt-1">Enrollment and identity management for the portal.</p>
        </div>
        ...
        <div className="flex items-center gap-4 bg-white px-5 py-3 rounded-2xl border border-slate-200/60 shadow-sm relative group overflow-hidden">
           ...
           <div className="relative z-10 text-right">
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">Authorization</p>
